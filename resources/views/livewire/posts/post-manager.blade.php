...
<div>
    <div class="col-md-12 mb-2">
        ...
        <!-- Modal -->
        <div wire:ignore.self class="modal" id="postModal" tabindex="-1" role="dialog" aria-labelledby="postModalLabel"
            aria-hidden="true">
            <!-- Modal Content -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form wire:submit.prevent="store">
                            ...
                            <button type="submit" class="btn btn-primary">{{ $postId ? 'Update' : 'Save' }}</button>
                        </form>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            @foreach ($posts as $post)
                                <tr>
                                    ...
                                    <td>{{ $post->body }}</td>
                                    <td>
                                        <button type="button" wire:click="edit({{ $post->id }})" class="btn btn-primary" data-toggle="modal" data-target="#postModal">Edit</button>
